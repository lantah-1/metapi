...
const RouteHeaderTemplates = lazy(() => import('./pages/RouteHeaderTemplates.js'));
...
export const sidebarGroups = [
  {
    ...
    items: [
      ...
      { to: '/route-header-templates', label: 'Header 模板', icon: <svg className="sidebar-item-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M7 7h10M7 12h5m-5 5h10M5 4h14a2 2 0 012 2v12a2 2 0 01-2 2H5a2 2 0 01-2-2V6a2 2 0 012-2z" /></svg> },
          ...
          <PageTransition>
            <Suspense fallback={<RouteLoadingFallback />}>
              <Routes>
                ...
                <Route path="/route-header-templates" element={<RouteHeaderTemplates />} />
